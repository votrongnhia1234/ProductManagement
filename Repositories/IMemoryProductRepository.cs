...
namespace ProductManagement.Repositories
{
    ...
    public class InMemoryProductRepository
    {
        ...
        private static void InitializeData()
        {
            ...
            {
                new Product { Id = _nextProductId++, ProductName = "Sofa hiện đại", Description = "Sofa 3 chỗ ngồi thiết kế hiện đại", ImgUrl = "./images/lv.jpg", Price = 15000000, CategoryId = 1 },
                new Product { Id = _nextProductId++, ProductName = "Bàn cà phê gỗ", Description = "Bàn cà phê gỗ tự nhiên cao cấp", ImgUrl = "/images/lv1.jpg", Price = 3500000, CategoryId = 1 },
